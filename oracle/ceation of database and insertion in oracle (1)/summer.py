...
for summer_id in range(3,100000):
    ...
    sql = "INSERT INTO summer(summer_id,province_id, district_id) VALUES (:1, :2, :3)"

    # Execute the SQL statement with the generated data
    cursor.execute(sql, (summer_id,province_id, district_id))
