...
for id_electronic in range(1, 100):
    ...
    sql = "INSERT INTO electronic_idcard_place (id_electronic, province_id, district_id, date1) VALUES (:1, :2, :3, TO_DATE(:4, 'YYYY-MM-DD'))"

    # Execute the SQL statement with the generated data
    cursor.execute(sql, (id_electronic, province_id, district_id, date1))
