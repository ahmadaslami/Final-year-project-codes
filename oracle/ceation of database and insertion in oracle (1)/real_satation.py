...
for real_residence_id in range(1, 10000):
    ...
    sql = "INSERT INTO real_residence (real_residence_id,province_id, district_id,village_id) VALUES (:1, :2, :3, :4)"

    # Execute the SQL statement with the generated data
    cursor.execute(sql, (real_residence_id,province_id, district_id,village_id))
